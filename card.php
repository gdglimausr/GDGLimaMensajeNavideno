...
<?php $img_fb = explode('/', $_GET['txt_to_linkfbaccount']); ?>
    <div id="page-wrap-card" style="margin-left:50%; margin-left:50%;" align="center">
      <h1>¡Feliz Navidad <?php print $_GET['txt_to_name']; ?>!</h1>
      <img src="https://graph.facebook.com/<?php print $img_fb[3];?>/picture?width=550"><br>
      <code style="font-family:'Trebuchet MS', Arial, Helvetica, sans-serif;">EL GDG Lima te desea UNA FELIZ NAVIDAD!. Yo <?php print $_GET['txt_from_name']; ?>, miembro del GDG Lima te deseo que pases una Feliz Navidad!</code>
